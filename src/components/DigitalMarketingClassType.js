...
import FlutterSchedule from "./FlutterSchedule";
import EthicalHackingSchedule from "./EthicalHackingSchedule";
import DigitalMarketingSchedule from "./DigitalMarketingSchedule";

const DigitalMarketingClassType= () => {
  ...
  return (
    ...
    <div className="md:w-[390px] w-[350px] bg-[#F6F9ED] rounded-xl shadow-bottom mb-4 p-4 ">
...
export default DigitalMarketingClassType;
