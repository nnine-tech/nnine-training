...
import AWSDevelopmentSchedule from "./AWSDevelopmentSchedule";
import AWSSolutionSchedule from "./AWSSolutionSchedule";
import BasicComputerSchedule from "./BasicComputerSchedule";

const BasicComputerClassType = () => {
...
export default BasicComputerClassType;
