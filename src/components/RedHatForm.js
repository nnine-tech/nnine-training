...
let courses = [
    {label:"Red Hat Open Shift Development I syllabus", value:"Red Hat Open Shift Development I syllabus"},
      ...
      <div className="w-[390px] p-[10px] h-[650px]  bg-[#F6F9ED] rounded-xl shadow-bottom flex flex-wrap flex-col">
        ...
        <div className="ml-4 font-poppins mr-4">
          <form onSubmit= {onSubmit}>
            ...
            <input
              type="number"
              id="phonenumber" value={phonenumber} onChange={(e)=>{
            ...
            <select
              className="border-2 border-[#0820FF] rounded-md p-2 w-full h-[44px] focus:outline-none focus:border-[#0820FF] mb-4"
              id="courseselection" value={courseselection} onChange={(e)=>{
            ...
            <textarea
              id="message" value={message} onChange={(e)=>{
