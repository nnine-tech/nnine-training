...
import UIUXSchedule from "./UIUXSchedule";
import WebdevelopmentSchedule from "./WebdevelopmentSchedule";

const WebdevelopmentClassType = () => {
  ...
  return (
    ...
    {/* <WebdevelopmentSchedule/> */}
    </div>
  );
};

export default WebdevelopmentClassType;
