...
const TrainersPage = () => {
  const trainersData = [
    ...
    },
    {
      ...
      name: "Niresh Dhakal",
      description:
        "Mr Dhakal holds Master degree from Otto-von-Guericke university, Germany. He is a RHEL Certified trainer and Full Stack Developer with more than 10 years of Academic/professional experience",
    },
    {
      imageUrl: "/sudan1.jpg",
      imageAlt: "sudan",
      ...
      description:
        "Meet our certified .NET trainer, backed by a decade of hands-on experience. With a profound understanding of .NET technologies, they deliver expert training and mentorship to empower learners in mastering the intricacies of the platform.",
    },
    {
      imageUrl: "/raj.png",
      imageAlt: "Raj",
      ...
      description:
        "Introducing our seasoned Network Engineer, boasting over 15 years of extensive industry experience. With a proven track record of success, they bring a wealth of knowledge and expertise to every project, ensuring robust and efficient network solutions",
    },
    {
      imageUrl: "/gyan.png",
      imageAlt: "Gyan",
    ...
    },
    {
      ...
      name: "Pradeep Aryal",
      description:
        "Mr Aryal holds a Master degree from Germany in Machine Learning and Data Science. He is working as data analyst and Machine learning engineer since last decade.",
    },
    {
      imageUrl: "/arjun.jpeg",
      imageAlt: "Arjun",
