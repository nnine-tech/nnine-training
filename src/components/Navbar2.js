...
const NavBar = () => {
  ...
  return (
    <div className="flex items-center justify-center">
      <nav
        className={`fixed top-20 w-full z-30 transition duration-300 ease-in-out mb-16 rounded-full bg-[#E9E9E9] shadow-lg`}
      >
          ...
          <div className="group flex items-center">
            ...
            <ul
              className={`lg:flex lg:flex-row lg:space-x-6 lg:p-5 ${
                isOpen ? "block" : "hidden"
              } lg:block absolute lg:static top-16 right-0 bg-white lg:bg-transparent w-full lg:w-auto`}
            >
              <li>
                <Link
                  href="/Popularcourses"
