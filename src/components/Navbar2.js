        ...
        <div className="flex items-center justify-center">
          <nav className=" fixed top-0 left-0 right-0 lg:mx-auto  lg:w-screen xl:w-[1275px] md:w-screen w-full z-30 transition duration-300 ease-in-out mb-16 rounded-full bg-[#FFFF] shadow-lg mt-16  lg:h-[80px] ">
            <div className="flex items-center justify-between px-6">
              ...
              {/* Navigation Links */}
              <ul
                className={`absolute lg:static lg:flex lg:flex-row lg:space-x-6 lg:p-5 bg-white lg:bg-transparent select-none w-full lg:w-auto transition-all duration-300 ease-in-out lg:h-auto h-[300px] ${
