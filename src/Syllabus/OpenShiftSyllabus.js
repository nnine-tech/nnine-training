        ...
        <div className="max-w-3xl mx-auto bg-white p-8 rounded-lg shadow-md">
          <div>
            <h1 className="text-blue-500 text-3xl font-bold mb-4">
              Red Hat OpenShift Development |: Introduction to Containers with
              podman DO188
            </h1>
            ...
            <h3 className="text-blue-500 font-bold mb-4">
              CHAPTER 2: Introduction to Containers and Podman
            </h3>
            <ul className="list-disc ml-8 mb-4">
            ...
            <h3 className="text-blue-500 font-bold mb-4">
              CHAPTER 3: Managing Container Images Using Podman
            </h3>
            <ul className="list-disc ml-8 mb-4">
              ...
              <li>
                HANDS-ON LAB Managing Container Images Using Podman and Skopeo
                on RHEL
              </li>
            </ul>

            <h3 className="text-blue-500 font-bold mb-4">
              CHAPTER 4: Managing Containers Using Podman
            </h3>
            <ul className="list-disc ml-8 mb-4">
            ...
            <h3 className="text-blue-500 font-bold mb-4">
              CHAPTER 5: Managing Pods Using Podman
            </h3>
            <ul className="list-disc ml-8 mb-4">
            ...
            <h3 className="text-blue-500 font-bold mb-4">
              CHAPTER 6: Creating Container Images Using Buildah
            </h3>
            <ul className="list-disc ml-8 mb-4">
              ...
              <li>
                HANDS-ON LAB Customizing Container Images Using Podman and
                Buildah on RHEL
              </li>
            </ul>

            <h3 className="text-blue-500 font-bold mb-4">
              CHAPTER 7: Exploring Podman and Kubernetes Interoperability
            </h3>
            <ul className="list-disc ml-8 mb-4">
              <li>Introduction to Kubernetes YAML Files</li>
              <li>Using Podman to Create a Kubernetes YAML File</li>
              <li>
                Running a Pod from a Podman-Generated Kubernetes YAML File Using
                Podman
              </li>
              <li>
                Running a Pod from a Podman-Generated Kubernetes YAML File Using
              ...
              <li>
                HANDS-ON LAB Exploring Podman and Kubernetes Interoperability on
                RHEL
              </li>
            </ul>

            <h3 className="text-blue-500 font-bold mb-4">
              CHAPTER 8: Using Podman to Create systemd Containers and Pods
            </h3>
            <ul className="list-disc ml-8 mb-4">
              <li>Introduction to systemd Containers</li>
              <li>Configuring Persistent systemd Containers and Pods</li>
              <li>
                HANDS-ON LAB Use Podman to Create Persistent systemd Containers
                and Pods on RHEL
              </li>
            </ul>

            <h3 className="text-blue-500 font-bold mb-4">
              CHAPTER 9: Managing Podman Containers Using Cockpit
            </h3>
            <ul className="list-disc ml-8 mb-4">
...
export default OpenShiftSyllabus;
