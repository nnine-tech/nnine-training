        ...
        <div className="max-w-3xl mx-auto bg-white p-8 rounded-lg shadow-md">
          <div>
            ...
            <p className="text-black ml-8">
              Overview of AWS services and infrastructure, AWS Global
            ...
            <p className="text-black ml-8">
              Managing IAM users, groups, roles, policies, and permissions.
            ...
            <p className="text-black ml-8">
              Launching EC2 instances, instance types, AMIs, security groups,
              key pairs, connecting to instances.
            </p>
            <h3 className="text-lg text-blue-500 font-semibold mb-2">
              2.2 AWS Lambda
            </h3>
            <p className="text-black ml-8">
              Serverless computing, creating Lambda functions, triggers,
            ...
            <p className="text-black ml-8">
              Creating buckets, uploading objects, versioning, lifecycle
              policies, bucket policies, S3 security.
            </p>
            <h3 className="text-lg text-blue-500 font-semibold mb-2">
              3.2 Amazon EBS (Elastic Block Store)
            </h3>
            <p className="text-black ml-8">
              Creating and attaching EBS volumes to EC2 instances, snapshots,
            ...
            <p className="text-black ml-8">
              Launching RDS instances, database engines (MySQL, PostgreSQL, SQL
              Server, etc.), backups, read replicas.
            </p>
            <h3 className="text-lg text-blue-500 font-semibold mb-2">
              4.2 Amazon DynamoDB
            </h3>
            <p className="text-black ml-8">
              NoSQL database service, creating tables, partition keys, indexes,
              querying data.
            </p>
            ...
            <p className="text-black ml-8">
              ...
              gateways, security groups, network ACLs.
            </p>
            <h3 className="text-lg text-blue-500 font-semibold mb-2">
              5.2 AWS Direct Connect
            </h3>
            <p className="text-black ml-8">
              Establishing dedicated network connections between on-premises
            ...
            <p className="text-black ml-8">
              Building and deploying APIs, integrating with AWS Lambda,
            ...
            <p className="text-black ml-8">
              Message queuing service, creating queues, sending and receiving
            ...
            <p className="text-black ml-8">
              Monitoring AWS resources, setting alarms, creating custom metrics,
              logging.
            </p>
            <h3 className="text-lg text-blue-500 font-semibold mb-2">
            ...
            <p className="text-black ml-8">
              Infrastructure as code, creating and managing AWS resources using
              templates.
            </p>
