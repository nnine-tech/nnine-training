        ...
        <div className="max-w-3xl mx-auto bg-white p-8 rounded-lg shadow-md">
          <div>
            ...
            <p className="text-black ml-8">
              Overview of Python, installation, basic syntax, data types,
            ...
            <p className="text-black ml-8">
              Conditional statements, loops, functions, parameters, return
              values, and scope.
            </p>
            <h3 className="text-lg text-blue-500 font-semibold mb-2">
            ...
            <p className="text-black ml-8">
              Lists, tuples, dictionaries, sets, comprehensions, sorting
            ...
            <p className="text-black ml-8">
              Defining classes, creating objects, attributes, methods,
            ...
            <p className="text-black ml-8">
              Encapsulation, polymorphism, method overriding, class and static
              methods.
            </p>
            ...
            <p className="text-black ml-8">
              Installation, project structure, understanding Django settings,
            ...
            <p className="text-black ml-8">
              Defining models, database migrations, querying data using Django
              ORM.
            </p>
            ...
            <h3 className="text-lg text-blue-500 font-semibold mb-2">
              4.1 Views and Templates
            </h3>
            <p className="text-black ml-8">
              Creating views, rendering templates, passing data to templates,
              URL routing.
            </p>
            <h3 className="text-lg text-blue-500 font-semibold mb-2">
              4.2 Forms and Form Handling
            </h3>
            <p className="text-black ml-8">
              Creating HTML forms, form validation, handling form submissions,
              form widgets.
            </p>
            {/* Continue with more topics under Building Web Applications with Django */}

            <h2 className="text-xl text-red-500 font-bold mb-4">
              5. Advanced Django Concepts
            </h2>
            <h3 className="text-lg text-blue-500 font-semibold mb-2">
              5.1 Authentication and Authorization
            </h3>
            <p className="text-black ml-8">
              User authentication, session management, permissions, and
            ...
            <p className="text-black ml-8">
              Building RESTful APIs, serializers, views, authentication, and
              testing.
            </p>
            {/* Continue with more advanced topics */}

            <h2 className="text-xl text-red-500 font-bold mb-4">
              6. Deployment and Project
            </h2>
            <h3 className="text-lg text-blue-500 font-semibold mb-2">
              6.1 Deploying Django Applications
            </h3>
            <p className="text-black ml-8">
              Hosting options, deploying Django applications on platforms like
            ...
            <p className="text-black ml-8">
              Building a real-world Django application from scratch, integrating
              various Django concepts.
            </p>
